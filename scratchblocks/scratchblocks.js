 ...
 * @license MIT
 * 
 * Modified by AllenBB314 on GitHub
 */
...
var scratchblocks = (function () {
  ...
  var movedExtensions = {};
  var extensions = _objectSpread2(_objectSpread2({}, {}), {}, {});
  var aliasExtensions = {};
  ...
  var scratchCommands = [{
    ...
    id: "~start",
    spec: "when game starts",
    shape: "hat",
    category: "events"
  }, {
    id: "~clicked",
    spec: "when any square clicked",
    shape: "hat",
    category: "events"
  }, {
    id: "~turn",
    ...
    id: "~movedPiece",
    spec: "when any piece moved",
    shape: "hat",
    category: "events"
  }, {
    id: "~capturedPiece",
    spec: "when any piece captures",
    shape: "hat",
    category: "events"
  }, {
    id: "~moveCapturePiece",
    spec: "when any piece moves or captures",
    shape: "hat",
    category: "events"
  }, {
    id: "~check",
    ...
    id: "gboard",
    spec: "get board",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gcol",
    spec: "get to move color",
    shape: "piece-color",
    category: "get"
  }, {
    id: "gcols",
    spec: "get color order",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gdead",
    ...
    id: "gpieceNum",
    spec: "get player's piece #",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceTypeNum",
    spec: "get player's piece type #",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceTypeNumAll",
    spec: "get all piece type #",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieces",
    spec: "get player's pieces",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceTypes",
    spec: "get player's piece types",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gclicked",
    spec: "get clicked square",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceFrom",
    spec: "get old square of moved piece",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceTo",
    spec: "get new square of moved piece",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gmovedCol",
    spec: "get color of moved piece",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gmovedPiece",
    spec: "get name of moved piece",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceDirs",
    spec: "get direction of colors",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gpieceAction",
    spec: "get action of moved piece",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gdeadPiecesNum",
    spec: "get player's dead pieces #",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "awin()",
    ...
    id: "gpieceNumAll",
    spec: "get total piece count",
    shape: "reporter",
    category: "get"
  }, {
    id: "groyalPos",
    spec: "get royal positions",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gplayerNames",
    spec: "get player names",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "gplayerRatings",
    spec: "get player ratings",
    shape: "array-reporter",
    category: "get"
  }, {
    id: "ginCheck",
    ...
    id: "acode",
    spec: "set code of %1 to %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "asetAt",
    spec: "set piece at %1 to %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "arevertCode",
    spec: "restore code of %1",
    inputs: ["%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "aaddLegal",
    spec: "add legal move %1 for %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "adelLegal",
    spec: "delete legal move %1 for %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "aclrLegal",
    spec: "clear legal moves for %1",
    inputs: ["%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "areplace",
    spec: "replace square %1 with %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "asetCol",
    spec: "set color of %1 to %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    ...
    id: "asetTime",
    spec: "set time of %1 to %2",
    inputs: ["%s", "%n"],
    shape: "stack",
    category: "actions"
  }, {
    id: "aaddEnPassant",
    spec: "add en passant %1 for %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "adelEnPassant",
    spec: "delete en passant %1 for %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "aclrEnPassant",
    spec: "clear en passant moves for %1",
    inputs: ["%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "asetDir",
    spec: "set direction of %1 to %2",
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "actions"
  }, {
    id: "arevertDir",
    spec: "restore direction of %1",
    inputs: ["%s"],
    shape: "stack",
    category: "actions"
  }, {
    ...
    id: "olg",
    spec: "log base %1 of %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "operators"
  }, {
    id: "oranI",
    spec: "random integer from %1 to %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "operators"
  }, {
    id: "oranD",
    spec: "random decimal from %1 to %2",
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "operators"
  }, {
    id: "oabs",
    spec: "absolute value of %1",
    inputs: ["%n"],
    shape: "reporter",
    category: "operators"
  }, {
  ...
  var overrideCategories = ["events", "get", "actions", "operators", "logic", "repeat", "conditions"].concat(_toConsumableArray(Object.keys(extensions)), _toConsumableArray(Object.keys(aliasExtensions)));
  ...
  var Input = /*#__PURE__*/function () {
    function Input(shape, value, menu) {
      ...
      this.isPieceColor = shape === "piece-color";     
      this.isPosition = shape === "position";
      this.isPieceDirection = shape === "piece-direction";
      this.isRound = shape === "number" || shape === "number-dropdown" || shape === "piece-direction";
      ...
      this.isDarker = shape === "boolean" || shape === "stack" || shape === "dropdown" || shape === "array";
      this.isSquare = shape === "string" || shape === "color" || shape === "dropdown" || shape === "array" || shape === "position";
    ...
    _createClass(Input, [{
      ...
      value: function stringify() {
        ...
        if (this.isArray || this.isPosition) {
          return "[" + text + "]";
        }
        if (this.isPieceColor || this.isPieceDirection) {
          return "(" + text + ")";
        }
  ...
  function parseLines(code, languages) {
    ...
    function pString() {
      ...
      if (/^\d+\s*,\s*\d+$/.test(trimmed)) {
        return new Input("position", trimmed);
      }

      if (/^.+,.+$/.test(trimmed)) {
        return new Input("array", trimmed);
      }

      if (/^[rbgy]$/i.test(trimmed)) {
        return new Input("piece-color", trimmed);
      }

      if (/^[0-3]$/.test(trimmed)) {
        return new Input("piece-direction", trimmed);
      }
  ...
  var SVG$1 = /*#__PURE__*/function () {
    ...
    _createClass(SVG, null, [{
      ...
      value: function getArm(w, armTop) {
        return "L 15 " + (armTop - 2) + " L 17 " + armTop + " L " + (w - 3) + " " + armTop + " L " + w + " " + (armTop + 3);
      }
    }, {
      key: "stackRect",
    ...
    _createClass(InputView, [{
      ...
      value: function draw(parent) {
        ...
        if (this.hasLabel) {
          ...
          w = Math.max(14, this.label.width + (
            this.shape === "string" || 
            this.shape === "number-dropdown" || 
            this.shape === "array" || 
            this.shape === "position" || 
            this.shape === "piece-color" || 
            this.shape === "piece-direction" ? 6 : 9
          ));
        } else {
  ...
  var SVG = /*#__PURE__*/function () {
    ...
    _createClass(SVG, null, [{
      ...
      value: function topNotch(w, y) {
        return "c 2 0 3 1 4 2 l 4 4 c 1 1 2 2 4 2 h 12 c 2 0 3 -1 4 -2 l 4 -4 c 1 -1 2 -2 4 -2 L " + (w - 4) + " " + y + " a 4 4 0 0 1 4 4";
      }
    }, {
      key: "getTop",
      value: function getTop(w) {
      ...
      key: "getArm",
      value: function getArm(w, armTop) {
        return "L 16 " + (armTop - 4) + " a 4 4 0 0 0 4 4 L 28 " + armTop + " " + SVG.topNotch(w, armTop);
      }
    }, {
      key: "getArmNoNotch",
      value: function getArmNoNotch(w, armTop) {
        return "L 16 " + (armTop - 4) + " a 4 4 0 0 0 4 4 L 28 " + armTop + " L " + (w - 4) + " " + armTop + " a 4 4 0 0 1 4 4";
      }
    }, {
      key: "stackRect",
      value: function stackRect(w, h, props) {
      ...
      value: function getCatTop(w) {
        return "M 0 32 c2.6,-2.3 5.5,-4.3 8.5,-6.2c-1,-12.5 5.3,-23.3 8.4,-24.8c3.7,-1.8 16.5,13.1 18.4,15.4c8.4,-1.3 17,-1.3 25.4,0c1.9,-2.3 14.7,-17.2 18.4,-15.4c3.1,1.5 9.4,12.3 8.4,24.8c3,1.8 5.9,3.9 8.5,6.1 L " + (w - 4) + " 32 a 4 4 0 0 1 4 4";
      }
    }, {
      key: "hatRect",
      value: function hatRect(w, h, props) {
  ...
  var cssContent = ".sb3-label {font: 500 12pt Helvetica Neue, Helvetica, sans-serif;word-spacing: +1pt;}.sb3-literal-number,.sb3-literal-string,.sb3-literal-number-dropdown,.sb3-literal-dropdown {word-spacing: 0;}.sb3-diff {fill: none;stroke: #000;}.sb3-diff-ins {stroke-width: 2px;}.sb3-diff-del {stroke-width: 3px;}svg .sb3-events {fill: #ffbf00;stroke: #cc9900;}svg .sb3-get {fill: #9966ff;stroke: #774dcb;}svg .sb3-actions {fill: #ed4242;stroke: #ca2b2b;}svg .sb3-operators {fill: #59c059;stroke: #389438;}svg .sb3-logic {fill: #0fbd8c;stroke: #0b8e69;}svg .sb3-repeat {fill: #4c97ff;stroke: #3373cc;}svg .sb3-conditions {fill: #ff8c1a;stroke: #db6e00;}svg .sb3-custom {fill: #ff6680;stroke: #ff3355;}svg .sb3-obsolete {fill: #ed4242;stroke: #ca2b2b;}svg .sb3-grey {fill: #bfbfbf;stroke: #909090;}svg .sb3-label {fill: #fff;}svg .sb3-input-color {stroke: #fff;}svg .sb3-input-number,svg .sb3-input-string {fill: #fff;}svg .sb3-literal-number,svg .sb3-literal-string {fill: #575e75;}.literal-array {fill: #ffffff;stroke: #888888;}.literal-position {fill: #e8f4f8;stroke: #2980b9;}.literal-piece-color {fill: #fadbd8;stroke: #c0392b;}.literal-piece-direction {fill: #d4efdf;stroke: #27ae60;}";
    ...
    _createClass(InputView, [{
      ...
      get: function get() {
        return {
          ...
          array: SVG.rect,
          position: SVG.rect,
          "piece-color": SVG.roundRect,
          "piece-direction": SVG.roundRect
        };
      }
    }]);
    return InputView;
